(function($) {
    ...
    let dailyMaxFilesCheckbox = $('.daily-max-files-checkbox'),
        planDailyMaxFilesInput = $('.plan-daily-max-files input'),
        planDailyMaxFilesSpan = $('.plan-daily-max-files span');

    dailyMaxFilesCheckbox.on('change', function() {
        if ($(this).prop('checked') == true) {
            planDailyMaxFilesInput.val('');
            planDailyMaxFilesInput.prop('disabled', true);
            planDailyMaxFilesSpan.addClass('disabled');
        } else {
            planDailyMaxFilesInput.prop('disabled', false);
            planDailyMaxFilesSpan.removeClass('disabled');
        }
    });
